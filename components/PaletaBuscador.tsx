  ...
  return (
    <>
      <button
        ...
        className="group flex h-8 w-full max-w-sm min-w-0 cursor-pointer items-center justify-between gap-1 rounded border border-primario/15 bg-fondo px-1 py-1 text-tinta-apagada shadow-xs transition-all duration-200 ease-out hover:border-primario/50 hover:text-tinta"
      >
